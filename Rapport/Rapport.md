...
![Comparaison des frameworks Backend](comparaison_back.png)
...
* **Performance (Vite) :** Nous avons utilisé **Vite** (le standard actuel) plutôt que des outils plus anciens. Sa vitesse de compilation instantanée améliore grandement le confort de travail cad que chaque modifications est appliqué immédiatement, ce qui évite de raffraichir la page ou relancer le serveur.
...
![Diagramme Session et Partie](uml_diagram.png)
